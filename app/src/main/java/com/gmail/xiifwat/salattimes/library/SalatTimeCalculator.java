...
/* This class is the engine. It contains trigonometrical bullshit that goes way over my head.
 * Kudos to all the open source coders.
 * Source code collected from:
...
public final class SalatTimeCalculator {
    ...
    public SalatTimeCalculator(double latitude, double longitude, Date date) {
        // Initialize vars
...
//        Date date = new Date(year, month - 1, day);
     ...
     * @param
     */
    public ArrayList<String> getFormattedTime() {

        double latitude = this._latitude;
        ...
        this.setAdjustHighLats(this.AngleBased);
        ...
        ArrayList<String> prayerTimes = this.getPrayerTimes(cal,
                latitude, longitude, timezone);
        prayerTimes.remove(4); //delete sunset time. because sunset & maghrib are same
